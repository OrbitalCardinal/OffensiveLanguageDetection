...
{
\sf\vspace{0.3em}\\
\texbf{Edson Raul Cepeda Marquez}
\vspace{0.1em}\\
...
agresiones y promover un ambiente sano para los usuarios. Con el uso de redes sociales las personas expresan sus opiniones llegando a esparcir mensajes de odio, insultos o discriminación. El objetivo de este proyecto es identificar correctamente texto con lenguaje ofensivo utilizando técnicas de procesamiento de lenguaje natural y redes neuronales profundas.
}
